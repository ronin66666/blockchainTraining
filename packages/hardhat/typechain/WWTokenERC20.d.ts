...
interface WWTokenERC20Interface extends ethers.utils.Interface {
  functions: {
    ...
    "setValutRole(address)": FunctionFragment;
...
export class WWTokenERC20 extends BaseContract {
  ...
  interface: WWTokenERC20Interface;
  ...
  callStatic: {
    ...
    setValutRole(valut: string, overrides?: CallOverrides): Promise<void>;
